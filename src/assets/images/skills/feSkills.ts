...
export const feSkills = [
    ...
    },
    {
        ...
        title: "TypeScript",
        desc: [
            "인터페이스, 제네릭 등 타입스크립트의 문법에 대해 이해하고 있습니다.",
            "타입을 정의하고 타입 기능을 활용 할 수 있습니다.",
        ],
    },
    {
        img: react,
        title: "React",
        desc: [
            "Virtual DOM과 같은 리액트 기본 원리를 이해하고 있습니다.",
    ...
    },
    {
        ...
        title: "React Query",
        desc: [
            "비동기 데이터 상태를 컴포넌트 상태와 분리하여 관리할 수 있습니다.",
            "비동기 데이터 상태를 지속적으로 동기화하고 업데이트 할 수 있습니다.",
        ],
    },
    {
        img: sc,
